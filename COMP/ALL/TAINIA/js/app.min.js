...
window.scrollTo(0, 0), window.onbeforeunload = function() {
    window.scrollTo(0, 0)
};
var prev = 0,
    down = !0,
    ...
    onScroll = function() {
        ...
        if (!(e < 0)) {
            if (e < ih) {
                var t = e / ih;
                split.style.width = w + (pw - w) * t + "px", heading.style.height = ih - (ih - dl) * t + "px", split.style.fontSize = fl - (fl - dl) * t + "px"
...
onScroll(), window.addEventListener("scroll", onScroll, !1), document.addEventListener("gesturechange", onScroll, !1);
var autoScroll = function() {
    var e = (window.pageYOffset || (document.documentElement || document.body.parentNode || document.body).scrollTop) + 1;
    window.scrollTo(0, e)
};
...
}, document.getElementsByClassName("privacy__link")[0].addEventListener("click", function(e) {
    e.preventDefault(), document.getElementsByClassName("privacy")[0].classList.toggle("active")
});
