...
;(function(window) {
	...
	var players = plyr.setup({
			controls : [],
			clickToPlay : false,
			autoplay: false // For demo purposes only: Autoplay the media on load. This is generally advised against on UX grounds. It is also disabled on iOS (an Apple limitation).
