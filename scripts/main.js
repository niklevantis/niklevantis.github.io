...
async function getInputValue() {
    ...
    if (value === "about") {
        ...
        trueValue(value);
        createText("Available commands: <br><span class='blue'>about</span>, <span class='blue'>blog </span>,<span class='blue'>clear</span>, <span class='blue'>cv</span>, <span class='blue'>date</span>, <span class='blue'>email</span>, <span class='blue'>exit</span>, <span class='blue'>github</span>, <span class='blue'>help</span>, <span class='blue'>ls</span>, <span class='blue'>ls -l</span>, <span class='blue'>music</span>, <span class='blue'>videos</span>");
    } else if (value === "ls -l") {
        trueValue(value);
